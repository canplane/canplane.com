...
<ul class="grid-12 ul-no-disc" style="margin-bottom: 4em;">
    <li class="grid grid-12">
        <h6 class="grid-1">소스 코드</h6>
        <p class="grid=2"><a href="https://github.com/canplane/PIVOT">GitHub</a></p>
    </li>
</ul>
<div class="grid-34">
...
<ul class="grid-12 ul-no-disc" style="margin-bottom: 4em;">
    <li class="grid grid-12">
        <h6 class="grid-1">제작 일자</h6>
        <p class="grid=2">2010. 10. 24.</p>
    </li>
</ul>
...
<div class="section grid">
<div class="grid-4">
    <h3><a href="/2014-05-11-pivot/">PIVOT →</a></h3>
</div>
</div>
